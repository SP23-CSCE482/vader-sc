...
import numpy as np
import math as mt
# Generated: fastfast Fourier transform coefficients
...
# Generated: This function is used to resolve n-1 coefficients, which are the same as the original ones. It is used to resolve n-1 coefficients, which are the same as the original ones.
...
# Generated: Helper function to compute inverse of fast Fourier transform coefficients.
