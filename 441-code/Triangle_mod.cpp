...
// Generated: Constructor, takes three points and creates a triangle.
Triangle::Triangle(
	glm::vec3 n1,
	glm::vec3 n2,
	glm::vec3 n3,
...
// Generated: Destructor. This is the destructor of a triangle.
Triangle::~Triangle()
{
}

// Generated: Intersect with a ray.
...
// Generated: Get the angle's ka.
glm::vec3 Triangle::getka(){
	return(this->ka);
}

// Generated: Get the K-d vector of the triangle.
glm::vec3 Triangle::getkd() {
	return(this->kd);
}

// Generated: Get the knot vector.
glm::vec3 Triangle::getks() {
	return(this->ks);
}

// Generated: Get the k-position of the triangle in km.
glm::vec3 Triangle::getkm() {
	return(this->km);
}

// Generated: Get the n-coordinate of the triangle in the triangle normal.
float Triangle::getn() {
	return(this->n);
}

// Generated: Get the maximum extent of this triangle.
Extent Triangle::getMaxExtent()
{
	return this->maxExtent;
}

// Generated: Get average position of the triangle in normalized coordinates.
